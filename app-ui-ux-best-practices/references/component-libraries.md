...
| Library | URL | Style | Rating |
|---------|-----|-------|--------|
| **Lucide React** | https://lucide.dev/ | Clean lines | ⭐⭐⭐⭐⭐ |
| **Heroicons** | https://heroicons.com/ | Tailwind official | ⭐⭐⭐⭐⭐ |
| **Tabler Icons** | https://tabler-icons.io/ | 5000+ free | ⭐⭐⭐⭐⭐ |
| **Phosphor Icons** | https://phosphoricons.com/ | 6 weights | ⭐⭐⭐⭐ |
...
### By Project Type (Reference Only)

| Project | Common Stack |
|---------|-------------|
| **SaaS Dashboard** | shadcn/ui + Radix + TanStack Table |
| **Marketing Site** | Tailwind + Framer Motion |
| **Enterprise App** | Ant Design or MUI |
| **Consumer Mobile** | Ionic or Ant Design Mobile |
